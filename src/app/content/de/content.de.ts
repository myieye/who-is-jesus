...
export const CONTENT: Content = {
    ...
    infoAbout: 'Jeder soll wissen, wer Jesus ist! Diese Webseite ist ein hilfreiches Werkzeug um zu entdecken, was die Evangelien (und sogar Jesus selbst) über Ihn zu sagen haben.',
    ...
    infoChronology: 'Die Chronologische Sortierung basiert auf <a href="http://www.lifeofchrist.com/Life/Harmony">Harmony of the Gospels</a> von <em>LifeofChrist.com</em>. Dies ist schlichtweg eine Annahme, wie die Herausgeber auch auf ihrer Webseite angeben.',
    verses,
    bibleBooks,
    tags,
};
